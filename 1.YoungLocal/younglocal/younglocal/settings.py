"""
Django settings for younglocal project.
...
SECRET_KEY = 'i3f*j5vlq!a1wxm1-v%(kyj4b-****eoh7sfay%(z-08cc%gqx'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['80.241.210.173','127.0.0.1','localhost']
...
WSGI_APPLICATION = 'younglocal.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'younglocal_data.db'),
    }
}
...
AUTH_USER_MODEL = 'yl.CustomUser' # new
